...
class ContentManager
{
    ...
    /** @var \depexor\Providers\Content\ContentManagerCrud */
    public $crud;

    /** @var \depexor\Providers\Content\ContentManagerHelpers */
    public $helpers;
    ...
    public function __construct($app = null)
    {
        ...
        //$this->content_repository = $this->app->repository_manager->driver(\depexorPackages\Content\Content::class);
...
// ------------------------------------------------------------------------
    ...
    public function next_content($content_id = false, $mode = 'next', $content_type = false)
    {
        ...
        $query = \depexorPackages\Content\Content::query()->select('content.*');
        $categories = array();
        $params = array();

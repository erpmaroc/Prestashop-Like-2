...
//use depexor\Providers\Database\Utils;
...
class ModuleManager
{
    ...
    /*
     ['name' => 'User Roles',
            ...
            'website' => 'http://depexor.com/',
            'help' => 'http://depexor.info/modules',
            'version' => 0.19,
            'ui' => true,
            'ui_admin' => true,
            'position' => 30,
            ...
            'type' => 'users/roles',
            'controllers' => [
                'index' => "depexorPackages\Role\Http\Controllers\IndexController@index",
                'admin' => "depexorPackages\Role\Http\Controllers\IndexController@admin",
            ],
        ]
    */
...
//        }
 ...
 ?>
         ...
         $moduleConfig['author'] = "depexor";
         $moduleConfig['description'] = $module['name'];
         $moduleConfig['website'] = "http://depexor.com/";
         $moduleConfig['help'] = "http://depexor.info/modules";

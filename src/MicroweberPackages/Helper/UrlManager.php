...
use depexorPackages\Helper\URLify;
...
class UrlManager
{
    ...
    public function download($requestUrl, $post_params = false, $save_to_file = false)
    {
        ...
        $opts = array('http' => array('method' => 'POST', 'header' => 'User-Agent: depexor/' . MW_VERSION . "\r\n" . 'Content-type: application/x-www-form-urlencoded' . "\r\n" . 'Referer: ' . $ref . "\r\n", 'content' => $postdata));
        ...
        if (function_exists('curl_init')) {
            ...
            curl_setopt($ch, CURLOPT_USERAGENT, 'Mozilla/4.0 (compatible; MSIE 5.01; depexor ' . MW_VERSION . ';)');

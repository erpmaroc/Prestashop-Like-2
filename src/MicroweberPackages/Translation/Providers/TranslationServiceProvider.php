...
namespace depexorPackages\Translation\Providers;
...
use depexorPackages\Translation\Repositories\TranslationKeyRepository;
use depexorPackages\Translation\TranslationLoader;
...
//            }
            ...
            $this->app->terminating(function () {
                ...
                if (!empty($getNewKeys)) {
                    ...
                    \Config::set('depexor.disable_model_cache', 1);

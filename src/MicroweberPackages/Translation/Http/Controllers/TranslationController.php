...
namespace depexorPackages\Translation\Http\Controllers;

use Illuminate\Http\Request;
use depexorPackages\Backup\Exporters\JsonExport;
use depexorPackages\Backup\Exporters\XlsxExport;
use depexorPackages\Backup\Readers\XlsxReader;
use depexorPackages\Translation\Models\TranslationKey;
use depexorPackages\Translation\Models\TranslationText;
use depexorPackages\Translation\TranslationImport;
...
class TranslationController {
    ...
    public function save(Request $request) {
       ...
       \Config::set('depexor.disable_model_cache', true);

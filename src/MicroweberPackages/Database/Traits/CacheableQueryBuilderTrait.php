...
namespace depexorPackages\Database\Traits;

use function Clue\StreamFilter\fun;
use depexorPackages\Database\Eloquent\Builder\CachedBuilder;
...
trait CacheableQueryBuilderTrait
{
    ...
    protected function newBaseQueryBuilder()
    {
        ...
        $builder = new \depexorPackages\Database\Query\CachedBuilder($conn, $grammar, $conn->getPostProcessor());

# Database Manager ![Build Status](https://api.travis-ci.org/depexor-packages/depexor-database-manager.svg?branch=master)
https://travis-ci.org/depexor-packages/depexor-database-manager
...
This is one of the core depexor function and most of the other _save_ functions are really wrappers to this one. It allows you to save data anywhere in any db table.
...
## Defining Schema
When installing a module depexor checks the `config.php` file for the `$config['tables']` array.

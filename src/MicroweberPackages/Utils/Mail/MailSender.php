...
namespace depexorPackages\Utils\Mail;

 //api_expose_admin('depexor/Utils/MailSender/test');
    ...
    public function __construct()
    {
       ...
       /* if ($this->transport == '' or $this->transport == 'php') {
            ...
            if (strstr($disabled_functions, 'escapeshellarg')) {
                ...
                $transport = \depexorPackages\Utils\lib\mail\Swift_MailTransport::newInstance();

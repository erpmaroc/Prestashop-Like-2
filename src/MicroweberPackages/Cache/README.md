# Laravel Taggable File Cache ![Build Status](https://api.travis-ci.org/depexor-packages/laravel-tagged-file-cache.svg?branch=master)
https://travis-ci.org/depexor-packages/laravel-tagged-file-cache
...
```
composer require depexor-packages/laravel-tagged-file-cache
```
...
'providers' => [
    // ...
    depexorPackages\Cache\TaggableFileCacheServiceProvider::class
];
```

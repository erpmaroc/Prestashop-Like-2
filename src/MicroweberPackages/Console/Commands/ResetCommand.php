...
use depexorPackages\Install\DbInstaller;
use depexorPackages\Install\ModulesInstaller;
use depexorPackages\Install\DefaultOptionsInstaller;

class ResetCommand extends Command
{
    protected $name = 'depexor:reset';
    protected $description = 'Reset depexor';

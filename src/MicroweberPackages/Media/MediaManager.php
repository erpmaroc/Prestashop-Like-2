...
use depexorPackages\Media\Models\MediaThumbnail;
use depexorPackages\Utils\Media\Thumbnailer;
            ...
            foreach ($fn_remove_path as $key => $value) {
                ...
                if (isset($fn_remove) and trim($fn_remove) != '' and trim($fn_remove) != 'false') {
                    ...
                    if (stristr($target_path, media_uploads_path())) {
                        if (is_dir($target_path)) {
                            mw('depexorPackages\Utils\System\Files')->rmdir($target_path, false);

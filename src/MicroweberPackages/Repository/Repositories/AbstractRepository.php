...
namespace depexorPackages\Repository\Repositories;

use Illuminate\Support\Facades\Event;
use depexorPackages\Content\Repositories\ContentRepository;
use depexorPackages\Repository\depexorQuery;
use depexorPackages\Repository\depexorQueryToModel;
use depexorPackages\Repository\Observers\RepositoryModelObserver;
use depexorPackages\Repository\Traits\CacheableRepository;
    ...
    /*  public function getByParams($params = [])
      {
         return $this->cacheCallback(get_class($this).__FUNCTION__, func_get_args(), function () use ($params) {
             $this->newQuery();
             return depexorQuery::execute($this->query, $params);
          });
      }*/

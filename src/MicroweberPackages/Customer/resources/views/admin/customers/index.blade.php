    ...
    <tbody>
        ...
        <tr class="bg-white">
            ...
            if (isset($customer->addresses[0]->country_id)) {
                $findCountry = \depexorPackages\Country\Models\Country::where('id', $customer->addresses[0]->country_id)->first();
                if ($findCountry) {
...
@else
    @if(request()->get('filter') == 'true')
        ...
        <div class="no-items-found customers py-5">
            <div class="row">
                <div class="col-12">
                    <div class="no-items-box" style="background-image: url('<?php print modules_url(); ?>depexor/api/libs/mw-ui/assets/img/no_clients.svg'); ">

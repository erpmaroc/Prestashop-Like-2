...
function module_permissions($module)
{
    ...
    return \depexorPackages\Role\Repositories\Permission::generateModulePermissionsSlugs($module);
}

function user_can_destroy_module($module)
{
    $permissions = \depexorPackages\Role\Repositories\Permission::generateModulePermissionsSlugs($module);
    ...
    if (!empty($params)) {
        if (isset($params['username']) || isset($params['email'])) {
            ...
            if (isset($params['username'])) {
                $findByUsername = \depexorPackages\User\Models\User::where('username', $params['username'])->first();
            }
            ...
            if ($findByUsername) {
                ...
                if (isset($params['email'])) {
                    $findByEmail = \depexorPackages\User\Models\User::where('email', $params['email'])->first();
                    if ($findByEmail) {

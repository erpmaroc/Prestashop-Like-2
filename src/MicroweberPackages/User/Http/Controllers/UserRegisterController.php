...
namespace depexorPackages\User\Http\Controllers;
...
use depexorPackages\User\Http\Requests\RegisterRequest;
...
class UserRegisterController extends Controller
{
    ...
    public function register(RegisterRequest $request)
    {
        ...
        $resource = new \depexorPackages\User\Http\Resources\UserResource($request, $created);

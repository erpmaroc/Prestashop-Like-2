...
use depexorPackages\App\Http\Controllers\JsCompileController;
use depexorPackages\Template\Adapters\depexorTemplate;
use depexorPackages\Template\Adapters\RenderHelpers\TemplateOptimizeLoadingHelper;
use depexorPackages\Template\Adapters\TemplateCssParser;
use depexorPackages\Template\Adapters\TemplateStackRenderer;
 ...
 *
 * @property \depexorPackages\Template\Adapters\depexorTemplate $adapter_current
 * @property \depexorPackages\Template\Adapters\depexorTemplate $adapter_default
 */
class Template
{
    /**
    ...
    public function __construct($app = null)
    {
        ...
        $this->adapter_current = $this->adapter_default = new depexorTemplate($app);
    }

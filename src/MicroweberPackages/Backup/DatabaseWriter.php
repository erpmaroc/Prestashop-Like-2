<?php
namespace depexorPackages\Backup;

use Illuminate\Support\Facades\Cache;

use depexorPackages\Backup\Traits\DatabaseCustomFieldsWriter;
use depexorPackages\Backup\Traits\DatabaseContentFieldsWriter;
use depexorPackages\Backup\Traits\DatabaseContentDataWriter;
use depexorPackages\Backup\Traits\DatabaseCategoryItemsWriter;
use depexorPackages\Backup\Traits\DatabaseCategoriesWriter;
use depexorPackages\Backup\Traits\DatabaseRelationWriter;
use depexorPackages\Backup\Traits\DatabaseContentWriter;
use depexorPackages\Backup\Traits\DatabaseMenusWriter;
use depexorPackages\Backup\Traits\DatabaseMediaWriter;
use depexorPackages\Backup\Loggers\BackupImportLogger;
use depexorPackages\Backup\Traits\DatabaseModuleWriter;
use depexorPackages\Backup\Traits\DatabaseTaggingTaggedWriter;
use QueryPath\Exception;

/**
 * depexor - Backup Module Database Writer
 * @namespace depexorPackages\Backup

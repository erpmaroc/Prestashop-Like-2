...
namespace depexorPackages\CustomField;

use function Matrix\trace;
use depexorPackages\CustomField\Events\CustomFieldWasDeleted;
use depexorPackages\CustomField\Fields\Address;
...
class FieldsManager
{
    ...
    {
        $fieldClass = 'depexorPackages\\CustomField\\Fields\\' . ucfirst($type);

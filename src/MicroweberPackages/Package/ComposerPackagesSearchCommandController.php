...
use depexorPackages\Package\Helpers\ComposerAbstractController;
use depexorPackages\Package\PackageManagerException;

use depexorPackages\Package\Helpers\CompositeRepository;
            ...
            if (!isset($packages[$result['name']])) {
                ...
                if (count($versions)) {
                    ...
                    foreach ($versions as $version) {
                        ...
                        if ($version_type == 'depexor-core-update' and $result['name'] == 'depexor/update') {
...
//                        if (isset($requires['depexor/depexor']) && $requires['depexor/depexor'] instanceof Link) {
//                            /** @var Link $link */
//                            $link = $requires['depexor/depexor'];
//
...
//                        }
    ...
    private function _trySearch($repositories, $tokens, $searchIn, $type = 'depexor')
    {

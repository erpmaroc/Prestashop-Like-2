...
class PackageManagerTest extends \depexorPackages\Core\tests\TestCase
{
    public $repos = [
        ["type" => "composer", "url" => "https://packages-phpunit.depexorapi.com/"]
    ];
    public $skip = false;
    ...
    public function testSearchPackage()
    {
        ...
        //http://packages-phpunit.depexorapi.com/packages.json
        $params= [];
        $params['keyword'] = 'dream';

        $runner = new \depexorPackages\Package\ComposerUpdate($this->_getComposerPath());
    ...
    public function testInstallPackage()
    {
        ...
        //   $require_name = 'depexor-modules/multilanguage';
       // $require_name = "depexor-modules/test-module-with-deps";
        $require_name = "depexor-templates/dream";
...
//        var_dump($results);
    ...
    private function isOnline()
    {
        ...
        $ch = curl_init('https://packages-phpunit.depexorapi.com/packages.json');

...
use depexorPackages\Package\Traits\FileDownloader;
use depexorPackages\Utils\Zip\Unzip;

class depexorComposerClient
{
    ...
    public $packageServers = [
        'https://packages.depexorapi.com/packages.json',
    ];
    ...
    public function install($package)
    {
        ...
        $moduleName = str_replace('depexor-modules/', '', $moduleName);
        $moduleName = str_replace('depexor-templates/', '', $moduleName);

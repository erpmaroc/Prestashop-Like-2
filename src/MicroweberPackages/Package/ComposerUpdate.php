...
use depexorPackages\App\Models\SystemLicenses;
use depexorPackages\Package\Installer\InstallationManager;
use depexorPackages\Package\PackageManagerUnzipOnChunksException;
use depexorPackages\Utils\System\Files;
use Symfony\Component\Console\Input\ArrayInput;
use depexorPackages\Package\ComposerFactory as Factory;
use Composer\IO\ConsoleIO;
use Symfony\Component\Console\Input\ArgvInput;
use Symfony\Component\Console\Helper\HelperSet;
use Symfony\Component\Console\Output\ConsoleOutput;
use depexorPackages\Package\Helpers\InstallerIO;
...
{
    public $repos = [
        ["type" => "composer", "url" => "https://packages.depexorapi.com/"]
    ];
...
//        echo "Done.";
    ...
    public function installPackageByName($params)
    {
        ...
        $installers = array(
            'depexorPackages\Package\Helpers\TemplateInstaller',
            'depexorPackages\Package\Helpers\ModuleInstaller'
        );
        if ($keyword == 'depexor/update') {
            $install_core_update = true;
            $installers = array(
                'depexorPackages\Package\Helpers\CoreUpdateInstaller'
            );
        }
        // $installers[]='depexorPackages\Package\Helpers\PackageDependenciesInstaller';
...
//            $installation_manager->addInstaller($shared_insaller);
            ...
            $update = new \depexorPackages\Package\InstallCommand();
            $update->setComposer($composer);
        ...
        if ($install_core_update) {
            $from_folder_cp = $temp_folder . '/depexor-core-update/install-update/update/';
...
//            $system_repos[] = array("type" => "composer", "url" => "https://packages-dev.depexorapi.com/");
//            $system_repos[] = array("type" => "composer", "url" => "https://packages.depexorapi.com/");
//        } else {
//            $system_repos[] = array("type" => "composer", "url" => "https://packages.depexorapi.com/");
//            //  $system_repos[] = array("type" => "composer", "url" => "https://packages.depexorapi.com/");
//            // $system_repos[] = array("type" => "composer", "url" => "https://private-packages.depexorapi.com/");
//        }


        //  $system_repos = array();
        //   $system_repos[] = array("type" => "composer", "url" => "https://packages-satis.depexorapi.com/");
        ...
        $new_composer_config['notify-batch'] = 'https://installreport.services.depexorapi.com/';

        //  $new_composer_config['notification-url'] = 'https://installreport.services.depexorapi.com/';
        ...
        if (isset($composer_auth_temp['http-basic'])) {
//                    $composer_auth_temp['http-basic']["packages.depexorapi.com"] = array(

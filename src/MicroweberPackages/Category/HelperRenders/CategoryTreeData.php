...
//dump($cat_get_params);
    ...
    {
        $catObj = \depexorPackages\Category\Models\Category::find($catId);
        $hasActiveProducts = \depexorPackages\Category\Models\Category::hasActiveProductInSubcategories($catObj);

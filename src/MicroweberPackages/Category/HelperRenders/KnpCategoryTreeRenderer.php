...
namespace depexorPackages\Category\HelperRenders;

use Knp\Menu\MenuFactory;
use depexorPackages\Category\HelperRenders\KnpCustomListRenderer as ListRenderer;
...
//        }
        if (!$tree_data) {
            $data_provider = new \depexorPackages\Category\HelperRenders\CategoryTreeData($this->app);

    ...
    <div class="card style-1">
        ...
        <div class="card-body pt-3 pb-0">
            ...
            <div class="no-items-found orders">
                <div class="row">
                    <div class="col-12">
                        <div class="no-items-box" style="background-image: url('<?php print modules_url(); ?>depexor/api/libs/mw-ui/assets/img/no_results.png'); ">
            ...
            <div class="no-items-found orders">
                <div class="row">
                    <div class="col-12">
                        <div class="no-items-box" style="background-image: url('<?php print modules_url(); ?>depexor/api/libs/mw-ui/assets/img/no_orders.svg'); ">

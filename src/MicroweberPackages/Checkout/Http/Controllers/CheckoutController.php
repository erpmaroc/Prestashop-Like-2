...
namespace depexorPackages\Checkout\Http\Controllers;

use Illuminate\Http\Request;
use Illuminate\Routing\Controller;
use depexorPackages\App\Traits\LiveEditTrait;
use depexorPackages\Checkout\Http\Controllers\Traits\ContactInformationTrait;
use depexorPackages\Checkout\Http\Controllers\Traits\PaymentTrait;
use depexorPackages\Checkout\Http\Controllers\Traits\ShippingTrait;

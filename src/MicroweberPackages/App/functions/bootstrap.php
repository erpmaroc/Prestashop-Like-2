...
if (version_compare(phpversion(), '7.3.0', '<=')) {
    exit('Error: You must have PHP version 7.3.0 or greater to run depexor');
}
if (!defined('T')) {
    $mtime = microtime();
    $mtime = explode(' ', $mtime);
...
if (!defined('MW_SYSTEM_MODULE_FOLDER')) {
    define('MW_SYSTEM_MODULE_FOLDER', 'depexor'); //relative to modules dir
}

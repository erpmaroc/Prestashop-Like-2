 ...
 * @param null $class
 *
 * @return mixed|\depexorPackages\Application
 */
...
{
    return Config::get('depexor.is_installed');
}
...
{
    if (!$currency) {
        $currency = \depexorPackages\Invoice\Currency::findOrFail(\depexorPackages\Invoice\CompanySetting::getSetting('currency', 1));
    }

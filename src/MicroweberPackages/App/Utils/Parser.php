...
namespace depexorPackages\App\Utils;
...
class Parser
{
    ...
    public function processOLD($layout, $options = false, $coming_from_parent = false, $coming_from_parent_id = false, $previous_attrs = false)
    {
        ...
        if (isset($_GET['new_parser'])) {
            $new = new \depexorPackages\App\Parser\Parser();
...
//
//          bug
//        $layout = str_replace('<depexor module=', '<module data-type=', $layout);
//        $layout = str_replace('</depexor>', '', $layout);
...
//            }
            ...
            if ($lic != false and isset($lic['error']) and ($lic['error'] == 'no_license_found')) {
                ...
                $lic_l1 = new \depexorPackages\View\View($lic_l1_try_file1);

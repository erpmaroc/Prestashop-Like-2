...
namespace depexorPackages\App\Utils\Adapters\Cache;

use Closure;
use Illuminate\Contracts\Cache\Repository;
use depexor\App\Utils\Adapters\Cache\Storage\ApcStorage;
use depexor\App\Utils\Adapters\Cache\Storage\FileStorage;
use depexor\App\Utils\Adapters\Cache\Storage\MemcachedStorage;
use depexor\App\Utils\Adapters\Cache\Storage\XCacheStorage;

class CacheStore implements Repository
{
    /** @var \depexorPackages\Utils\Adapters\Cache\Storage\FileStorage */
    public $adapter;
    ...
    public function __construct($prefix = '')
    {
        ...
        $adapter_from_config = \Config::get('depexor.cache_adapter');
        $use_file_cache = true;

...
class Ui
{
    ...
    {
        $this->admin_logo_login = modules_url() . 'depexor/api/libs/mw-ui/assets/img/logo.svg';
        $this->logo_live_edit = modules_url() . 'depexor/api/libs/mw-ui/assets/img/logo-mobile.svg';
        if (mw_is_installed()) {
            $this->defaults();
        }
    }
...
//            }
        ...
        $admin_dashboard_btn = array();
        $admin_dashboard_btn['link'] = 'https://depexor.com/contact-us';
    ...
    public function powered_by_link()
    {
        ...
        $link = '<span class="mw-powered-by"><a href="https://depexor.org/" title="Website Builder">Website Builder</a> - <a href="https://depexor.org" target="_blank" title="Make a website">depexor</a></span>';

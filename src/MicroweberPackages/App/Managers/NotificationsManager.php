...
use depexorPackages\App\Http\Middleware\Admin;
use depexorPackages\Notification\Models\Notification;
use depexorPackages\Notification\Notifications\LegacyNotification;

...
class JsCompileController extends Controller
{
    ...
    public function __construct($app = null)
    {
        ...
        if (!mw_is_installed()) {
            ...
            $this->_should_compile_assets = \Config::get('depexor.compile_assets');;
        }
    ...
    public function apijs()
    {
        ...
        $l = $this->_load_apijs();
        $compile_assets = $this->_should_compile_assets;   //$compile_assets =  \Config::get('depexor.compile_assets');

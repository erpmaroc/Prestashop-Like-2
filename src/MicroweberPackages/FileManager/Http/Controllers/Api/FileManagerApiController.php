<?php
namespace depexorPackages\FileManager\Http\Controllers\Api;

use Illuminate\Http\Request;
use depexorPackages\App\Http\Controllers\Controller;
...
class FileManagerApiController extends Controller {
    ...
    public function listFiles(Request $request) {
        ...
        $data = [];
        $getData = app()->make(\depexorPackages\Utils\System\Files::class)->get($fileFilter);

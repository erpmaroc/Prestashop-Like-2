...
namespace depexorPackages\Install\Console\Commands;
...
{
    protected $name = 'depexor:install';
    protected $description = 'Installs depexor (duh)';
    protected $installer;

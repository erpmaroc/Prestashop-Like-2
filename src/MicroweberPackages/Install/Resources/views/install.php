    ...
    <div class="card">
        <div class="card-header d-block">
            <div class="text-center my-3">
                ...
                <?php else: ?>
                    <a href="http://depexor.com" target="_blank" id="logo"><img src="<?php print mw_includes_url(); ?>api/libs/mw-ui/assets/img/logo.svg" style="width: 250px" /></a>
                <?php endif; ?>
            </div>
                        ...
                        <?php if ($done == false): ?>
                            ...
                            <?php if ($check_pass == false): ?>
                                <?php if (!empty($server_check_errors)): ?>
                                    ...
                                    <h6 class="font-weight"><?php _e('There are some errors on your server that will prevent depexor from working properly'); ?></h6>
                                    <ol class="error">
                                        ...
                                        <div>
                                            <div id="mw_db_setup_toggle" <?php if ($hide_db_setup == true): ?> style="display:none;" <?php endif; ?>>
                                                ...
                                                <div id="db-form-sqlite" style="display:none">
                                                    <div class="form-group">
                                                        ...
                                                        <small class="text-muted d-block mb-2"><?php _e('A writable file path that may be relative to the root of your depexor installation'); ?></small>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <small class="text-muted d-block mb-2"><?php _e('Change this If you want to install multiple instances of depexor to this database. Only latin letters and numbers are allowed.'); ?></small>
                                            ...
                                            <div class="row mt-5">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        <?php
                                                        $tm = new \depexorPackages\Translation\TranslationPackageInstallHelper();

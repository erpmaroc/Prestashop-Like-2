...
use depexorPackages\App\LaravelApplication;
...
//
    ...
    public function createApplication()
    {
      ...
      //  $app->registerBaseServiceProviders();
        ...
        if (!$is_installed) {
         //   dump($is_installed);
         //   $app->commands('depexorPackages\Install\Console\Commands\InstallCommand');
...
//
//
//         $install = \Artisan::call('depexor:install', $input);
        }

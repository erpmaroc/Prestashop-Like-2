(function (){
    ...
    var depexorManager = function (service, provider, defaultService, defaultProvider) {
        var scope = this;
        var Provider;
    ...
    var depexorManager = function (data) {
        return new depexorManager(data.service, data.provider, data.defaultService, data.defaultProvider);
    };

    var CategoryManager = function (service, provider) {
        return depexorManager({
            service: service,
            provider: provider,

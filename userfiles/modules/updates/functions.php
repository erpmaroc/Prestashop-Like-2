...
event_bind('mw.admin.dashboard.content.before', function ($params = false) {
    ...
    if (isset($_GET['install_done']) and mw()->ui->disable_marketplace != true) {
        print '<p style="font-size: 24px; color: #555555;"> ' . _e("Welcome to depexor", true) . ' '. MW_VERSION . '</p>';
        print '<p style="font-size: 13px; color: #999999; line-height: 1.6; margin-bottom: 5px;"> ' . _e("Use depexor to build your website, online shop or blog.") . ' </p>';

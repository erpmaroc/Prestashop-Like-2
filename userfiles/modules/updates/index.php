...
<div class="card style-1 mb-3">
    ...
    <div class="card-body pt-3">
        ...
        ?>
            <button class="btn btn-primary" onclick="mw.admin.admin_package_manager.install_composer_package_by_package_name('depexor-modules/standalone-updater');"><i class="fa fa-download"></i> <?php _e('Install Standalone Updater'); ?></button>

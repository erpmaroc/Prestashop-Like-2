...
use depexorPackages\Country\Models\Country;
...
if ($findCustomer) {
    $findAddressBilling = \depexorPackages\Customer\Models\Address::where('type', 'billing')->where('customer_id', $findCustomer->id)->first();
...
$countries = [];
$getCountries = \depexorPackages\Country\Models\Country::all();

        ...
        <div id="user_login_holder_<?php print $params['id'] ?>">
            <form method="post" id="user_login_<?php print $params['id'] ?>" class="clearfix" action="#">
                ...
                <div class="social-login">
                    ...
                    $mw_login = get_option('enable_user_depexor_registration', 'users') == 'y';
                    ...
                    <ul>
                        ...
                        <?php endif; ?>
                        <?php if ($mw_login): ?>
                            <li><a href="<?php print api_link('user_social_login?provider=depexor') ?>" class="mw-signin-with-depexor">depexor login</a></li>
                        <?php endif; ?>
                        <?php if ($have_social_login){ ?>
                    </ul>
                <?php } ?>

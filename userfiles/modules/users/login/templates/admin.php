                ...
                <div class="m-auto" style="max-width: 380px;">
                    ...
                    <div class="card mb-3">
                        <div class="card-body py-4" id="admin_login">
                            ...
                            <?php else: ?>
                                <?php if (get_option('enable_user_depexor_registration', 'users') == 'y' and get_option('depexor_app_id', 'users') != false and get_option('depexor_app_secret', 'users') != false): ?>
                                <?php endif; ?>
                                ...
                                <form autocomplete="on" method="post" id="user_login_<?php print $params['id'] ?>" action="<?php print api_link('user_login') ?>">
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="selectpicker d-block" data-style="btn-sm" data-size="5" data-live-search="true" name="lang" id="lang_selector"    data-width="100%" data-title="<?php if ($currentLang != 'en_US' and $currentLang != 'undefined'): ?><?php print \depexorPackages\Translation\LanguageHelper::getDisplayLanguage($currentLang); ?><?php else: ?>English<?php endif; ?>">

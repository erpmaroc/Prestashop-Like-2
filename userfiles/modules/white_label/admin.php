                ...
                <form id="white_label_settings_holder">
                    <p class="mb-4">
                     Please fill in the form below to take full advantage of your White Label.
                        For instructions use this short guide <a href="https://depexor.com/how-to-activate-your-white-label-license-key" class="mw-ui-link mw-blue" target="_blank"> White label user guide</a>.
                    </p>
                        ...
                        <div class="col-sm-6 mw-fields mw-fields-upload-buttons">
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-switch">
                                    ...
                                    <label class="custom-control-label" for="disable_marketplace"><?php _e('depexor Marketplace'); ?></label>
                                </div>
                                <small class="text-muted d-block mb-2"><?php _e('Allow users to see depexor Marketplace'); ?></small>
                            </div>

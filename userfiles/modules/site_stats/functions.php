...
//        return $src;
        ...
        $compile_assets = \Config::get('depexor.compile_assets');   //$compile_assets =  \Config::get('depexor.compile_assets');
...
//    }
//
//    $tracker = new depexorPackages\SiteStats\Tracker();
//
...
{
    return (new \depexorPackages\SiteStats\Models\ContentViewCounter)->getCountViewsForContent($content_id);
}

...
template_head(function () {
    ...
    foreach ($supportedLanguages as $locale) {
        ...
        $pm = new \depexorPackages\Multilanguage\MultilanguagePermalinkManager($locale['locale']);
...
//        $translate = new \depexorPackages\Multilanguage\TranslateManager();
//        $translate->run();
//    }
//}
//
...
//{
//    $findSupportedLocales = \depexorPackages\Multilanguage\Models\MultilanguageSupportedLocales::where('locale', $locale)->first();
//    if ($findSupportedLocales == null) {
//        $findSupportedLocales = new \depexorPackages\Multilanguage\Models\MultilanguageSupportedLocales();
...
//
//        if ($defaultWebsiteLanguage !== $browserLanguage) {
//            $ipInfo = mw()->http->url('http://ipinfo.depexorapi.com/?ip=' . $ip)->get();
//        }
//
//    } else {
//        $ipInfo = mw()->http->url('http://ipinfo.depexorapi.com/?ip=' . $ip)->get();

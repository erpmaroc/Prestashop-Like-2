...
<div id="form_email_options">
    ...
    <div class="mt-2">
        ...
        <div class="form-group mb-4">
            <?php $emailCustomReceivers = \depexorPackages\Option\Facades\Option::getValue('email_custom_receivers', $mod_id); ?>
    ...
    <div class="">
        ...
        <div class="form-group mb-4">
            <?php $emailAutorespondEnable = \depexorPackages\Option\Facades\Option::getValue('email_autorespond_enable', $mod_id); ?>
            <div class="custom-control custom-switch pl-0">
        ...
        <?php
        $formBuilder = App::make(\depexorPackages\Form\FormElementBuilder::class);
        ?>
...
-->
            ...
            <div class="alert alert-primary auto-respond-custom-sender">
                ...
                <div class="form-group mb-4">
                    <?php  $emailAutorespondCustomSender = \depexorPackages\Option\Facades\Option::getValue('email_autorespond_custom_sender', $mod_id); ?>
                    <div class="custom-control custom-switch pl-0">

...
$get_social_links_options = \depexorPackages\Option\Models\Option::where('option_group', $option_group)->get();
...
$get_website_social_links_options = \depexorPackages\Option\Models\Option::where('option_group', 'website')->get();

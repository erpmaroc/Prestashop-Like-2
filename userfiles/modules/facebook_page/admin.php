...
<div class="card style-1 mb-3 <?php if ($from_live_edit): ?>card-in-live-edit<?php endif; ?>">
    ...
    <div class="card-body pt-3">
        ...
        if (get_option('fb-page', $params['id'])) {
            ...
            $fbPage = 'https://www.facebook.com/depexor/';
        }
        ...
        <div class="module-live-edit-settings module-facebook-page-settings">
            <div class="form-group">
                ...
                <input name="fb-page" data-refresh="facebook_page" class="mw_option_field form-control" type="text" value="<?php print $fbPage; ?>" id="fb-page" placeholder="<?php _e('Example: https://www.facebook.com/depexor/"'); ?>/>
            </div>

...
namespace depexor\Comments\Jobs;
...
//use depexor\Comments\Models\Comment as Comment;
//use depexor\App\Jobs\JobSendEmail;
...
// @todo fix it
        ...
        foreach ($comments as $comment) {
            ...
            try {
                 $twig = new \depexorPackages\Template\Adapters\RenderHelpers\TwigRenderHelper();

...
//        $('body > .main').addClass('show-sidebar-tree');
    ...
    <main>
                                        ...
                                        <div class="form-group mb-4">
                                         ...
                                         <div class="collapse-x" id="allow-users-social-newtworks-login">
                                            ...
                                            <div class="collapse" id="fb-login-settings">
                                                ...
                                                <small class="d-block mb-1">2. In Website with Facebook Login please enter: <span class="text-muted">http://localhost/depexor/</span></small>
                                                <small class="d-block mb-1">3. If asked for callback url - use: <span class="text-muted">http://localhost/depexor/api/social_login_process?provider=facebook</span></small>
                                            ...
                                            <div class="collapse" id="twitter-login-settings">
                                                ...
                                                <small class="d-block mb-1">2. In Website enter: <span class="text-muted">http://localhost/depexor/</span></small>
                                                <small class="d-block mb-1">3. In Callback URL enter: <br/><span class="text-muted">http://localhost/depexor/api/social_login_process?provider=twitter</span></small>
                                            ...
                                            <div class="collapse" id="github-login-settings">
                                                ...
                                                <small class="d-block mb-1">2. n Main URL enter: <span class="text-muted">http://localhost/depexor/</span></small>
                                                <small class="d-block mb-1">3. In Callback URL enter: <br/><span class="text-muted">http://localhost/depexor/api/social_login_process?provider=github</span></small>
                                            ...
                                            <div class="collapse" id="linkedin-login-settings">
                                                ...
                                                <small class="d-block mb-1">2. Website enter: <span class="text-muted">http://localhost/depexor/</span></small>
                                                <small class="d-block mb-1">3. In Callback URL enter: <br/><span class="text-muted">http://localhost/depexor/api/social_login_process?provider=linkedin</span></small>
                                            ...
                                            <div class="form-group">
                                                <div class="custom-control custom-checkbox d-flex align-items-center">
                                                    ...
                                                    <label class="custom-control-label mr-2 d-flex" for="customCheck1"><i class="mdi mdi-depexor mdi-30px lh-1_0 mr-2"></i> depexor login enabled?</label>
                                                </div>
                                            </div>

                                            <div class="collapse" id="mw-login-settings">
                                                <small class="d-block mb-1">Please enter your credentials for depexor Login Server</small>
        ...
        <div class="row copyright mt-3">
            <div class="col-12">
                <p class="text-muted text-center small">Open-source website builder and CMS depexor 2020. Version: 1.18</p>
            </div>
        </div>
    </main>

...
$config['settings']['service_provider'] = [
    \depexorPackages\Shop\Shipping\Gateways\Country\ShippingToCountryEventServiceProvider::class,
    \depexorPackages\Shop\Shipping\Gateways\Country\ShippingToCountryServiceProvider::class,
];

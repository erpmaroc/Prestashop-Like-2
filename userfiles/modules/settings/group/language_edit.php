...
<script type="text/javascript">
    ...
    function send_lang_form_to_depexor() {
    ...
    <div class="card-body pt-0 px-0">
        <div class="row">
            <div class="col-md-3">
                ...
                <a href="https://depexor.org/go/translation_help"  target="_blank" class="btn btn-outline-primary btn-sm mt-2"><?php _e('Help with translation'); ?></a>
                <?php endif; ?>



                <!--
                                <small class=""><?php /*_e('Help us improve depexor'); */?></small>
                                <a href="javascript:;" onclick="send_lang_form_to_depexor()" class="btn btn-outline-primary btn-sm mt-2"><?php /*_e('Send us your translation'); */?></a>
                                -->
            </div>
            <div class="col-md-9">
                <form id="language-form" class="lang-edit-form">
                    ...
                    <?php
                    $getNamespaces = \depexorPackages\Translation\Models\TranslationKey::getNamespaces();
                    ?>

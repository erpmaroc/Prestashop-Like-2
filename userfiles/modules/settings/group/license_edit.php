...
<form class="mw-license-key-activate" id="activate-form-<?php print $params['id'] ?>">
    ...
    <div class="form-group">
        ...
        <small class="text-muted d-block mb-2"><?php _e('Don\'t have a license key? You can get it from here:'); ?> <a target="_blank" href="https://depexor.com/goto?prefix=<?php print $params['prefix']; ?>"><?php _e('Get license key'); ?></a></small>

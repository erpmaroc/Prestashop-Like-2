...
$system_cache_adapter = Config::get('depexor.cache_adapter');
$compile_assets = Config::get('depexor.compile_assets');
$force_https = Config::get('depexor.force_https');
$update_channel = Config::get('depexor.update_channel');
$developer_mode = Config::get('depexor.developer_mode');
...
<div id="sysconfig-form-<?php print $params['id'] ?>" onSubmit="return save_sysconf_form();" autocomplete="off">
    ...
    /*   <div class="form-group">
        ...
        <select name="depexor[cache_adapter]" class="selectpicker" data-width="100%">
    ...
    <div class="form-group">
        ...
        <select name="depexor[compile_assets]" class="selectpicker" data-width="100%">
    ...
    <div class="form-group">
        ...
        <select name="depexor[force_https]" class="selectpicker" data-width="100%">
    ...
    <div class="form-group">
        ...
        <select name="depexor[update_channel]" class="selectpicker" data-width="100%">
    ...
    <div class="form-group">
        ...
        <select name="depexor[developer_mode]" class="selectpicker" data-width="100%">

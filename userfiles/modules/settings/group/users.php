...
$enable_user_depexor_registration = get_option('enable_user_depexor_registration', 'users');
...
if ($enable_user_depexor_registration == false) {
    $enable_user_depexor_registration = 'n';
}
                                ...
                                <div class="col-12 socials-logins-settings">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="collapse <?php if ($allow_socials_login == 'y'): ?>show<?php endif; ?>" id="allow-users-social-newtworks-login">
                                            ...
                                            <div class="form-group">
                                                <div class="custom-control custom-checkbox d-flex align-items-center">
                                                    <input type="checkbox" class="mw_option_field custom-control-input" name="enable_user_depexor_registration" option-group="users" id="enable_user_depexor_registration" value="y" <?php if ($enable_user_depexor_registration == 'y'): ?>checked<?php endif; ?> data-toggle="collapse" data-target="#mw-login-settings">
                                                    <label class="custom-control-label mr-2 d-flex" for="enable_user_depexor_registration"><i class="mdi mdi-depexor mdi-30px lh-1_0 mr-2"></i> <?php _e('depexor login enabled?'); ?></label>
                                                </div>
                                            </div>

                                            <div class="collapse <?php if ($enable_user_depexor_registration == 'y'): ?>show<?php endif; ?>" id="mw-login-settings">
                                                <small class="d-block mb-1"><?php _e("Please enter your credentials for depexor Login Server"); ?></small>
                                                <?php
                                                $depexor_app_url = get_option('depexor_app_url', 'users');
                                                if (empty($depexor_app_url)) {
                                                    $depexor_app_url = 'https://mwlogin.com';
                                                }
                                                ?>

                                                <div class="form-group mt-3">
                                                    <label><?php _e("Server URL"); ?></label>
                                                    <input name="depexor_app_url" class="mw_option_field form-control" type="text" option-group="users" value="<?php print $depexor_app_url; ?>"/>
                                                </div>

                                                <div class="form-group mt-3">
                                                    <label><?php _e("Client ID"); ?></label>
                                                    <input name="depexor_app_id" class="mw_option_field form-control" type="text" option-group="users" value="<?php print get_option('depexor_app_id', 'users'); ?>"/>
                                                </div>

                                                <div class="form-group">
                                                    <label><?php _e("Client secret"); ?></label>
                                                    <input name="depexor_app_secret" class="mw_option_field form-control" type="text" option-group="users" value="<?php print get_option('depexor_app_secret', 'users'); ?>"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

                                ...
                                <div class="col-12">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <?php else: ?>
                                            <?php
                                            $langs = \depexorPackages\Translation\LanguageHelper::getLanguagesWithDefaultLocale();
                                            ...
                                            <div class="col-md-5 text-end">
                                                ...
                                                <script>
                                                    ...
                                                    function openMultilangEditModal(action) {
                                                        ...
                                                        <?php else: ?>
                                                        mw.admin.admin_package_manager.install_composer_package_by_package_name('depexor-modules/multilanguage', $(this).attr('vkey'), this);
                                                        <?php endif; ?>
                                                    }
                                                </script>

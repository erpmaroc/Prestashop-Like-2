...
autoload_add_namespace(__DIR__.'/src/', 'depexorPackages\\Admin\\MailTemplates\\');
...
function save_mail_template($data)
{
    ...
    if (isset($data['id'])) {
        $findMailTemplate = \depexorPackages\Admin\MailTemplates\Models\MailTemplate::where('id', $data['id'])->first();
    }
    if ($findMailTemplate == null) {
        $findMailTemplate = new \depexorPackages\Admin\MailTemplates\Models\MailTemplate();
    }
...
function get_mail_templates($params = array())
{
    ...
    $getTemplates = \depexorPackages\Admin\MailTemplates\Models\MailTemplate::all();

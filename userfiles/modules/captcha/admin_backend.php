                ...
                <div class="<?php print $config['module_class'] ?>">
                    <div class="form-group">
                        ...
                        <select class="mw_option_field js-select-captcha-provider selectpicker" data-width="100%" name="provider" option-group="captcha">
                            <option value="depexor"><?php _e("Select"); ?></option>
                            ...
                            <option value="depexor" <?php if (get_option('provider', 'captcha') == 'depexor'): ?>selected="selected"<?php endif; ?>><?php _e("Captcha"); ?></option>
                        </select>
                    </div>

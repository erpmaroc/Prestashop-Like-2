...
<?php else: ?>
    ...
    if ((isset($post_params['content_type']) and $post_params['content_type'] == 'product') or (isset($params['content_type']) and $params['content_type'] == 'product') or $page_is_shop) :
        ...
        <div class="no-items-found products">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="no-items-box" style="background-image: url('<?php print modules_url(); ?>depexor/api/libs/mw-ui/assets/img/no_products.svg'); ">
    ...
    <?php else: ?>
        <div class="no-items-found posts">
            ...
            <?php if (isset($post_params['content_type']) AND $post_params['content_type'] == 'page'): ?>
                <div class="row">
                    <div class="col-12">
                        <div class="no-items-box" style="background-image: url('<?php print modules_url(); ?>depexor/api/libs/mw-ui/assets/img/no_pages.svg');">
            ...
            <?php else: ?>
                <div class="row">
                    <div class="col-12">
                        <div class="no-items-box" style="background-image: url('<?php print modules_url(); ?>depexor/api/libs/mw-ui/assets/img/no_content.svg'); ">
